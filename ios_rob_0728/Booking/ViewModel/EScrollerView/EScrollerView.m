...
-(id)initWithFrameRect:(CGRect)rect ImageArray:(NSArray *)imgArr TitleArray:(NSArray *)titArr
{
	...
	if ((self=[super initWithFrame:rect])) {
        ...
        //说明文字层
        UIView *noteView=[[UIView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height-25,self.bounds.size.width,43)];
//        [noteView setBackgroundColor:[UIColor redColor]];
        
//        UIImageView *rotateImg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"h_rotate_bg"]];
//        [noteView addSubview:rotateImg];
        ...
        UIImageView *noteImg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"h_rotate_f_bg"]];
        [noteView addSubview:noteImg];
        noteTitle=[[UILabel alloc] initWithFrame:CGRectMake(0, 0, noteImg.frame.size.width, noteImg.frame.size.height)];
        ...
        UIImageView *notesImg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"h_rotate_s_bg"]];
        notesImg.frame = CGRectMake(noteImg.frame.size.width, 0, notesImg.frame.size.width, notesImg.frame.size.height);
        [noteView addSubview:notesImg];
        
        UILabel *desLa = [[UILabel alloc] init];
        desLa.frame = notesImg.frame ;
        [desLa setBackgroundColor:[UIColor clearColor]];
        desLa.textColor = [UIColor whiteColor];
        desLa.textAlignment = NSTextAlignmentCenter;
        [desLa setFont:[UIFont systemFontOfSize:13]];
        desLa.text = @"温莎卡OK大赛";
        [noteView addSubview:desLa];
