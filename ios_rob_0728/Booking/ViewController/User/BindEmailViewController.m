...
- (void)initTextInfo
{
    ...
    [self setTextField:accountText withPlaceholder:@"请输入邮箱" withSecure:NO];
...
- (void)viewDidLoad
{
    ...
    NSArray *imgArr = [NSArray arrayWithObjects:@"registe_mail.png",@"verification_code.png", nil];
    ...
    UIButton *finishBtn = [[UIButton alloc] initWithFrame:CGRectMake(10, 120, 300, 40)];
